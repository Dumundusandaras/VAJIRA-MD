...
global.owner = [process.env.OWNER_NUMBER] || ['94728969436'] // Owner number , (අයිතිකරුගේ නම්බර් එක )

module.exports = {    
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=zUFA3RgD#LIwppJQwBRbeLYAr_E7KqzyFFce89iBp6nMivXn7NE4'
...
OWNER_NUMBER: process.env.OWNER_NUMBER || '94728969436'  ,    
ALIVE: process.env.ALIVE || `default`,
OWNER_NAME: process.env.OWNER_NAME || 'DUMIYA' ,     
